...
(function($){
   ...
   jmtab.prototype = {
   	   init:function(){
             ...
             $(options.container).find(".jm-tabs-title .tab").data("options")
             $(options.container).find(".jm-tabs-title .tab").each($.proxy(function(k,tab){
       ...
       bindevent:function(tab){
   	   	      ...
   	   	      ind = $(tab).parent().parent().prevAll().size();
   	   ...
   	   tabContent:function(tab){
                ...
                if(!options.skipanim){
                    if(options.animation == 'animMoveHor'){
                        ...
                        $(options.container).find(".jm-tab-content").hide();
		                    $(options.container).find(".jm-tab-content:eq("+ind+")").show();
                    }
                }else{
